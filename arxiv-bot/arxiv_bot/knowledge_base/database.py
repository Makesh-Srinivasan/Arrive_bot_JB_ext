...
class Pinecone_class:
    ...
    def __init__(
        ...
        # initialize connection to Pinecone_class
    ...
    def add(
        ...
        """Encodes texts and upserts to Pinecone_class index.

        :param texts: List of text strings to encode
        :type texts: list
        :param ids: List of ids to upsert to Pinecone_class index
        :type ids: list, optional
        :param metadata: List of metadata to upsert to Pinecone_class index
            ...
            try:
                ...
                for item in upsert:
                    try:
                        ...
                        print("Error during upsert, see Pinecone_class.log for details")
